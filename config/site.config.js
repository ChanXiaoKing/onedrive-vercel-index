...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'moyu@moyu112.onmicrosoft.com',
  ...
  email: 'mailto:moyukings@163.com',
...
<script>
    var now = new Date();
    function createtime(){ var grt= new Date("1/8/2023 00:00:00");//修改建站时间
    ...
    if(String(snum).length ==1 ){ snum = "0" + snum; } document.getElementById("timeDate").innerHTML = "本站安全运行 "+dnum+" 天";
